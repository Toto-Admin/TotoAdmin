...
const routes = [
    {
        ...
        children: [
            {
                path: 'dashboard', loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e(10)]).then(__webpack_require__.bind(null, /*! ../../Main/dashboard/dashboard.module */ "BnmD")).then(m => m.DashboardModule)
            },
            {
                path: 'customer', loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(2), __webpack_require__.e(7)]).then(__webpack_require__.bind(null, /*! ../../Main/customer/customer.module */ "XqCq")).then(m => m.CustomerModule)
            },
            {
                path: 'provider', loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e(2), __webpack_require__.e(3), __webpack_require__.e(5)]).then(__webpack_require__.bind(null, /*! ../../Main/provider/provider.module */ "fH3i")).then(m => m.ProviderModule)
            },
            {
                path: 'assessment', loadChildren: () => __webpack_require__.e(/*! import() */ 8).then(__webpack_require__.bind(null, /*! ../../Main/assessment/assessment.module */ "Ipsq")).then(m => m.AssessmentModule)
            },
            {
                path: 'jobs', loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e(2), __webpack_require__.e(3), __webpack_require__.e(6)]).then(__webpack_require__.bind(null, /*! ../../Main/jobs/jobs.module */ "ODt3")).then(m => m.JobsModule)
            },
            {
                path: 'payment', loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(9)]).then(__webpack_require__.bind(null, /*! ../../Main/payment/payment.module */ "JLCc")).then(m => m.PaymentModule)
            }
        ]
    },
];
